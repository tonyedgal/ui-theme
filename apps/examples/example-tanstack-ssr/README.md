...
- `createThemeServerFns()` for cookie persistence
- `beforeLoad()` theme hydration on the server
- `TanStackUIThemeProvider` wired to server callbacks
- CSS-based `system` theme handling for zero-flash system mode
